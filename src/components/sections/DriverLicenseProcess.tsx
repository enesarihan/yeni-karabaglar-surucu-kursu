  ...
  const examProcesses = [
    {
      step: 1,
      title: 'Kursa Kayıt',
      description: 'Sürücü kursuna kayıt olun ve gerekli belgeleri teslim edin.',
      duration: '1 gün',
      details: [
  ...
  const faqs = [
    {
      ...
      answer: 'B sınıfı ehliyet için 18 yaş, A2 sınıfı ehliyet için 18 yaş şartı vardır. 17 yaşında kursa başlayabilir, 18 yaşını doldurduktan sonra sınava girebilirsiniz.'
    },
    {
      question: 'Sınavlarda kaç kez deneme hakkım var?',
      answer: 'Teorik sınav için sınırsız deneme hakkınız vardır. Pratik sınav için de sınırsız deneme hakkınız bulunmaktadır, ancak her sınav için ücret ödemeniz gerekir.'
    },
    {
      question: 'Sağlık raporu ne kadar süre geçerli?',
      answer: 'Sürücü belgesi sağlık raporu 6 ay süreyle geçerlidir. Bu süre içinde sınavlarınızı tamamlamanız gerekmektedir.'
    },
    {
      question: 'Direksiyon dersi saatleri nasıl belirlenir?',
      answer: 'Minimum 24 saat direksiyon dersi zorunludur. Ders saatlerinizi eğitmeninizle ve kendi programınıza uygun şekilde planlayabilirsiniz.'
    },
    {
      question: 'Ehliyet ne kadar sürede hazır olur?',
      answer: 'Sınavları başarıyla geçtikten sonra ehliyetiniz 1-2 iş günü içinde hazır olur ve teslim alabilirsiniz.'
    },
    {
      question: 'Başka şehirde aldığım kursu burada devam ettirebilir miyim?',
      answer: 'Evet, nakil işlemi yaparak kurs eğitiminizi başka bir şehirde devam ettirebilirsiniz. Bunun için gerekli evrakları tamamlamanız gerekir.'
    }
  ];
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-foreground/80 mb-4">{process.description}</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-white/90 mb-8 max-w-3xl mx-auto">
            Deneyimli eğitmenlerimiz ve kapsamlı eğitim programımızla ehliyet alma 
            sürecinizde size yardımcı olalım. Hemen iletişime geçin!
          </p>
