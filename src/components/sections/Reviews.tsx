...
const Reviews = () => {
  ...
  return (
    <section
      id="reviews"
      className="py-20 bg-gradient-to-br from-primary/5 via-secondary/10 to-accent"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-foreground/70 max-w-3xl mx-auto">
            Bizimle ehliyet alan öğrencilerimizin deneyimlerini okuyun ve neden
            bizi tercih ettiklerini keşfedin.
          </p>
        </motion.div>
