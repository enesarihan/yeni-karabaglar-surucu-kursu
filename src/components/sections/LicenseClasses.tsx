...
const LicenseClasses = () => {
  ...
  const licenseClasses = [
    {
      ...
      icon: Bike,
      color: 'bg-blue-500',
      description: 'Hafif motosiklet ve üç tekerlekli araçlar için ehliyet',
      requirements: [
      ...
      validityPeriod: '15 yıl',
      canDrive: [
        'Motor gücü 11 kW\'ı geçmeyen motosikletler',
        '125 cm³\'ü geçmeyen motorlu bisikletler',
        'Üç tekerlekli hafif araçlar'
      ]
    },
    {
      class: 'A2',
      ...
      minAge: 18,
      vehicles: ['35kW\'a kadar motosiklet', 'Güç/ağırlık oranı 0.2kW/kg\'ı geçmeyen'],
      icon: Bike,
      color: 'bg-green-500',
      description: 'Orta güçteki motosikletler için ehliyet',
      requirements: [
        '18 yaşını doldurmuş olmak',
        'A1 ehliyetine sahip olmak (2 yıl) veya direkt sınava girmek',
        'Sağlık raporu',
        'Psikoteknik rapor',
        'Teorik ve pratik sınav'
      ],
      validityPeriod: '15 yıl',
      canDrive: [
        'Motor gücü 35 kW\'ı geçmeyen motosikletler',
    ...
    },
    {
      ...
      icon: Bike,
      color: 'bg-red-500',
      description: 'Tüm motosikletler için ehliyet',
      requirements: [
        '24 yaşını doldurmuş olmak (direkt) veya 20 yaş (A2\'den geçiş)',
        'A2 ehliyetine sahip olmak (2 yıl) veya direkt sınava girmek',
        'Sağlık raporu',
        'Psikoteknik rapor',
        'Teorik ve pratik sınav'
      ],
      ...
      canDrive: [
        'Tüm motosikletler',
        'Üç tekerlekli motorlu araçlar (15 kW üzeri)',
        'A1 ve A2 sınıfı araçlar'
      ]
    },
    {
      class: 'B',
      ...
      icon: Car,
      color: 'bg-primary',
      description: 'En yaygın ehliyet sınıfı - otomobil ve hafif ticari araçlar',
      requirements: [
        '18 yaşını doldurmuş olmak',
        'Sağlık raporu',
        'Psikoteknik raporu',
      ...
      validityPeriod: '15 yıl',
      canDrive: [
        'Azami ağırlığı 3500 kg\'ı geçmeyen otomobiller',
        'En fazla 8 kişi taşıyabilen araçlar',
    ...
    },
    {
      ...
      icon: Truck,
      color: 'bg-blue-600',
      description: 'B sınıfı araçlarla ağır römork çekmek için',
      requirements: [
        'B sınıfı ehliyete sahip olmak',
        '18 yaşını doldurmuş olmak',
        'Sağlık raporu',
        'Pratik sınav (teorik sınav yok)'
      ],
      validityPeriod: '15 yıl',
      canDrive: [
        'B sınıfı araçlar',
        '750 kg\'ı aşan römorklar',
        'Toplam ağırlığı 4250 kg\'ı geçmeyen araç-römork kombinasyonu'
      ]
    },
    {
      class: 'C1',
      ...
      icon: Truck,
      color: 'bg-orange-500',
      description: 'Orta boy kamyonlar için ehliyet',
      requirements: [
        'B sınıfı ehliyete sahip olmak',
        '18 yaşını doldurmuş olmak',
        'Sağlık raporu (özel)',
    ...
    },
    {
      ...
      icon: Truck,
      color: 'bg-red-600',
      description: 'Ağır kamyonlar için ehliyet',
      requirements: [
        'B sınıfı ehliyete sahip olmak',
      ...
      validityPeriod: '5 yıl',
      canDrive: [
        '7500 kg üzeri kamyonlar',
        '750 kg\'a kadar römork',
        'C1 ve B sınıfı araçlar'
      ]
    },
    {
      class: 'D1',
      ...
      icon: Bus,
      color: 'bg-purple-500',
      description: 'Küçük otobüsler için ehliyet',
      requirements: [
        'B sınıfı ehliyete sahip olmak',
        '21 yaşını doldurmuş olmak',
        'Sağlık raporu (özel)',
    ...
    },
    {
      ...
      icon: Bus,
      color: 'bg-indigo-600',
      description: 'Büyük otobüsler için ehliyet',
      requirements: [
        'B sınıfı ehliyete sahip olmak',
      ...
      validityPeriod: '5 yıl',
      canDrive: [
        '16+ kişi taşıyan otobüsler',
        '750 kg\'a kadar römork',
        'D1 ve B sınıfı araçlar'
      ]
    },
    {
      class: 'F',
      name: 'Traktör',
      minAge: 16,
      vehicles: ['Traktör', 'İş makinesi', 'Tarım araçları'],
      icon: Tractor,
      color: 'bg-green-600',
      description: 'Tarım ve iş makineleri için ehliyet',
      requirements: [
        '16 yaşını doldurmuş olmak',
        'Sağlık raporu',
        'Psikoteknik raporu',
      ...
      canDrive: [
        ...
        'İş makineleri',
        'Tarım araçları',
        'Lastik tekerlekli iş makineleri'
      ]
    },
    {
      class: 'G',
      ...
      icon: Construction,
      color: 'bg-yellow-600',
      description: 'Ağır iş makineleri için ehliyet',
      requirements: [
        '18 yaşını doldurmuş olmak',
        'Sağlık raporu',
        'Psikoteknik raporu',
  ...
  const selectedLicense = licenseClasses.find(license => license.class === selectedClass);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">
            Türkiye'deki Ehliyet Sınıfları
          </h1>
          <p className="text-lg text-foreground/70 max-w-3xl mx-auto">
            Türkiye'de geçerli tüm ehliyet sınıfları, yaş şartları, sürülebilecek araçlar 
            ve özellikler hakkında kapsamlı rehber.
          </p>
        </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div>
                <div className="flex items-center space-x-4 mb-6">
                  <div className={`${selectedLicense.color} text-white p-4 rounded-xl flex items-center justify-center`}>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-accent rounded-lg p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="font-semibold text-primary">Minimum Yaş</span>
                    </div>
                  ...
                  <div className="bg-accent rounded-lg p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="font-semibold text-secondary">Geçerlilik</span>
                    </div>
                    <p className="text-2xl font-bold text-foreground">
                  ...
                  <div className="text-sm text-blue-700 space-y-2">
                    {selectedLicense.class === 'B' && (
                      <>
                        ...
                        <p>• Otomatik vites araçlar için ayrı belirtim gerekir</p>
                        <p>• İlk 2 yıl deneme süresi uygulanır</p>
                      </>
                    )}
                    {selectedLicense.class.includes('A') && (
                      <>
                        <p>• Kask takma zorunluluğu vardır</p>
                        <p>• Motosiklet eğitimi zorunludur</p>
                        <p>• Hava koşullarına dikkat edilmelidir</p>
                      </>
                    )}
                    {(selectedLicense.class === 'C' || selectedLicense.class === 'D') && (
                      <>
                        <p>• Ticari araç kullanım belgesi gerekebilir</p>
                        <p>• Düzenli sağlık kontrolü zorunludur</p>
                        <p>• Profesyonel yeterlilik belgesi gerekebilir</p>
                      </>
                    )}
                    {(selectedLicense.class === 'F' || selectedLicense.class === 'G') && (
                      <>
                        <p>• İş güvenliği eğitimi alınmalıdır</p>
                        <p>• Makine kullanım sertifikası gerekebilir</p>
                        <p>• Özel çalışma alanları için ek izin gerekebilir</p>
                      </>
                    )}
                  </div>
                </div>
            ...
            {licenseClasses.map((license) => (
              ...
              >
                <div className="flex items-center space-x-3 mb-4">
                  <div className={`${license.color} text-white p-3 rounded-lg flex items-center justify-center`}>
                    <license.icon className="w-6 h-6" />
                  </div>
                  <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{license.validityPeriod}</span>
                  </div>
                </div>
        ...
        >
          ...
          <p className="text-lg text-white/90 mb-8 max-w-3xl mx-auto">
            Deneyimli eğitmenlerimizle tüm ehliyet sınıfları için eğitim veriyoruz. 
            Detaylı bilgi almak ve kayıt olmak için hemen iletişime geçin.
          </p>
