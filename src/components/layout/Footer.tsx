          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                30 yılı aşkın deneyimimizle Karabağlar ve çevresinde güvenli
                sürüş eğitimi veriyoruz. Deneyimli eğitmenlerimiz ve modern
                araçlarımızla ehliyet alma sürecinizde yanınızdayız.
              </p>
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            <div className="text-center">
              ...
              >
                ...
                <span className="text-xs  transition-opacity ">Was Here.</span>
              </Link>
            </div>
          </div>
        </div>
